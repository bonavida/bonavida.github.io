...
This said, there are several ways to solve this issue. For example, we could use the [Context API](https://es.reactjs.org/docs/context.html) from React to create a custom internationalization layer, but I think that was way too complicated for the purpose of this application, which is to offer the possibility of having a few posts translated into other languages — something similar to what **Dan Abramov** does in his blog [Overreacted](https://overreacted.io/).
